'@file: loading';
angular.module(PROJACT_Name).directive('abLoading', function ($timeout, CONFIG, $rootScope) {
    var directive = {
        restrict: 'AE',
        replace: true,
        scope: true,
        template: '<div id="lightboss_poplayer" class="{{poplayer.type}}"><hgroup><header><em></em><div class="loader"></div></header><article>{{poplayer.content||"加载中..."}}</article><footer></footer></hgroup></div>',
...
angular.module(PROJACT_Name).directive('loading', function ($timeout, CONFIG, $rootScope) {
    return {
        link: function (scope, element, attrs) {
